...
plot \
"$FILE_NAME_25" using 2:3 axis x1y1 w l title "$FILE_NAME_25" lc rgb "#a0a0fc" lw 1.0, \
"$FILE_NAME_26" using 2:3 axis x1y1 w l title "$FILE_NAME_26" lc rgb "#afa0fc" lw 1.0,
